...
@interface ResourcesLibViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong)NSMutableArray *CourseArry;
@end

@implementation ResourcesLibViewController
@synthesize CourseArry;
- (void)viewDidLoad {
    [super viewDidLoad];
    [self setTopTitle:@"资源库"];
...
{
    CourseScorViewController *vc = [CourseScorViewController new];
