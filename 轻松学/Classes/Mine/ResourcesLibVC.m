...
@interface ResourcesLibVC ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong)NSMutableArray *CourseArry;
@end

@implementation ResourcesLibVC
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (CellView == nil)
    {
        ...
        UILabel *labText=[self createLabel:CGRectMake(CGRectGetMaxX(imageHead.frame)+LRYScreenpW(30), LRYScreenpH(20), LRYScreenpW(600), LRYScreenpH(50)) title:courese.nameStr fontSize:18 textColor:YWQColor(105, 105, 105)];
        [labText setBackgroundColor:[UIColor clearColor]];
        [CellView addSubview:labText];
        
        UILabel *nameText=[self createLabel:CGRectMake(CGRectGetMaxX(imageHead.frame)+LRYScreenpW(30), CGRectGetMaxY(labText.frame)+LRYScreenpH(10), LRYScreenpW(600), LRYScreenpH(20)) title:courese.TeachnameStr fontSize:15 textColor:YWQColor(105, 105, 105)];
        nameText.alpha=0.5;
